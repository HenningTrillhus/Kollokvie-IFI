...
export const messages = {
  ...
  "time.choose": { no: "Velg tid", en: "Choose time" },
  "time.hour": { no: "Time", en: "Hour" },
  ...
  "date.choose": { no: "Velg dato", en: "Choose date" },
  "date.type": { no: "Skriv inn dato", en: "Type a date" },
  "date.typePlaceholder": { no: "dd.mm.åååå", en: "dd.mm.yyyy" },
  "cal.addEvent": { no: "Ny hendelse", en: "New event" },
  "rate.limited": {
    no: "Rolig, du gjør ting litt for fort. Vent et øyeblikk og prøv igjen.",
    en: "Easy there, you're going a bit fast. Wait a moment and try again.",
  },
  "cal.note": { no: "Notat", en: "Note" },
  "cal.noteLabel": { no: "Notat for dagen", en: "Note for the day" },
  "cal.notePlaceholder": { no: "Skriv et notat…", en: "Write a note…" },
  ...
  "profile.bioHeading": { no: "Om meg", en: "About" },
